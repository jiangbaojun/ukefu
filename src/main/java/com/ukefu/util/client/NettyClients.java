...
/**
 * @Description:	客户、坐席等socket连接维护类。通过google的ArrayListMultimap按照userid维护SocketIOClient。处理多终端问题
 * @ClassName:		NettyClients.java
 * @author：         		姜宝俊
 * @Date：			2017-10-19 下午5:00:41
 */
